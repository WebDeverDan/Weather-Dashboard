...
$(document).ready(function () {
  ...
  // localStorage.getItem("history", JSON.parse(history));
      ...
      .then((data) => {
        ...
        fetch(
          ...
          .then((data) => {
            ...
            // localStorage.setItem(uvValue, JSON.stringify(data));
            ...
            fetch(forecastAPI)
              ...
              .then((data) => {
                ...
                cityButton.addEventListener("click", function changeCityInfo() {
                  city.innerHTML = cityValue;
                  temp.innerHTML = tempValue;
                  wind.innerHTML = windValue;
                  humidity.innerHTML = humidityValue;
